...
def dump_classifier_and_data(clf, dataset, feature_list, num_clf):
    CLF_PICKLE_FILENAME = "my_classifier_{0}.pkl".format(num_clf)
...
def load_classifier_and_data():
    ...
    for file in os.listdir("./"):
        if file.startswith("my_classifier_"):
            clf = pickle.load(open(file, "r"))
