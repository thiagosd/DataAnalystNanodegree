...
def lineplot(hr_year_csv):
    ...
    # your code here
    hr_year_df = pd.read_csv(hr_year_csv)

    gg = ggplot(hr_year_df, aes('yearID', 'HR')) + geom_point(color='red') + geom_line(
        color='red') + ggtitle('# of Home Runs by Year') + xlab('Year') + ylab('# of Home Runs')
