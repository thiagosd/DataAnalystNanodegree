...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        # your code here
        if df['Pclass'][passenger_index] == 3:
            predictions[passenger['PassengerId']] = 0
        elif df['Sex'][passenger_index] == 'female':
            predictions[passenger['PassengerId']] = 1
        elif (df['Pclass'][passenger_index] == 1 or 2) and \
            df['Parch'][passenger_index] > 0 and df['Age'][passenger_index] < 18:
            predictions[passenger['PassengerId']] = 1
        else:
            predictions[passenger['PassengerId']] = 0
        #
    return predictions
print(custom_heuristic('C:\DataAnalystDegree\DataAnalystNanodegree\Intro to Data Science\Project 1 - Titanic Survivor Data\\titanic_data.csv'))
