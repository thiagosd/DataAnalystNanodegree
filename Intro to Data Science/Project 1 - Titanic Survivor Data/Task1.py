...
def simple_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        if df['Sex'][passenger_index] == 'female':
            predictions[passenger['PassengerId']] = 1
        else:
            predictions[passenger['PassengerId']] = 0
    return predictions

print(simple_heuristic('C:\DataAnalystDegree\DataAnalystNanodegree\Intro to Data Science\Project 1 - Titanic Survivor Data\\titanic_data.csv'))
